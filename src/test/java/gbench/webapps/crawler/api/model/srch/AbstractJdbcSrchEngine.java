...
public abstract class AbstractJdbcSrchEngine {
    ...
    public Stream<Document> expand2docs(final IRecord rec, final String col) {
        String name = rec.str(col);// 获取名称项目
    ...
    public class IndexJdbcSession {
         ...
         * @param docs 文档集合
         */
        public void add(final Document[] docs, boolean bcommit) {
            for (var doc : docs) {
                try {
         ...
         */
        public void update(final Term term, final Document doc, boolean bcommit) {
            try {
         ...
         */
        public void update2(final Term term, Field[] updates, boolean bcommit) {
            try {
                @SuppressWarnings("unused")
         ...
         * @param bcommit 是否给与立即提交
         */
        public void remove(Term[] terms, boolean bcommit) {
            try {
         ...
         * @param size 返回最大长度
         */
        public List<IRecord> boolean_query(IRecord rec, int size) {
         ...
         */
        public List<IRecord> get(Query query, int size) {
         ...
         * @param rec 查询定义
         */
        public List<IRecord> sqlgets(IRecord rec) {
         ...
         * @param rec 查询定义
         */
        public IRecord sqlget1(IRecord rec) {
        ...
        private IRecord attributes = REC();// 会话中的状态数据
    ...
    public synchronized void writeIndexes(final Consumer<IndexWriter> primecs, Consumer<IndexWriter> postcs) {
        ...
        try (final var writer = new IndexWriter(this.getIndexHome(), iwc);) {
            ...
            @SuppressWarnings("unused") final var seqnum = writer.commit();
     ...
     * @return PageQuery
     */
    public PageQuery getPageQuery(final Query query, boolean binit) {
    ...
    public class PageQuery {
         ...
         * @param reader
         */
        public PageQuery(IndexReader reader, final Query query) {
            this.reader = reader;
         ...
         */
        public void initialize(int pageSize, Sort sort, Collection<String> fieldsToLoad, boolean exactHitsCount) {
            if (pageSize < 0)
        ...
        public Optional<PageData> getData() throws IOException {
            ...
            if (sort != null) {
                ...
                int hitsThreshold = exactHitsCount ? Integer.MAX_VALUE : PAGEQUEY_DEFAULT_TOTAL_HITS_THRESHOLD; // 是否返回精准的匹配数量
        ...
        private IndexSearcher searcher; // 查询器
        private IndexReader reader;// 索引访问器
    }
