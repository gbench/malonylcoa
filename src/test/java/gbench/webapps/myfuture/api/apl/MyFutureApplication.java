package gbench.webapps.myfuture.api.apl;
 ...
 * 
 * 启动参数: <br>
 * --server.port=7010 或 <br>
 * VM argument: <br>
 * -Dspring.config.location=classpath:/config/webapps/myfuture/api/application.yml
 * <br>
 ...
 * @author xuqinghua
 */
@ComponentScan(basePackages = { "gbench.webapps.myfuture.api" })
