package gbench.webapps.myfuture.xchg.config;
...
public class DataAppConfig {
	...
	public MyDataApp dataApp(final DataSource ds, final @Value("${gbench.dbreset:true}") Boolean dbreset,
			final @Value("${gbench.datafile:F:/slicef/ws/gitws/malonylcoa/src/test/java/gbench/webapps/myfuture/xchg/model/data/datafile.xlsx}") String datafile) {
