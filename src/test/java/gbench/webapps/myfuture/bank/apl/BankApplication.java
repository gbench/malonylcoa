package gbench.webapps.myfuture.bank.apl;
 ...
 * VM argument: <br>
 * -Dspring.config.location=classpath:/config/webapps/myfuture/bank/application.yml
 * <br>
 ...
 * @author xuqinghua
 */
@ComponentScan(basePackages = { "gbench.webapps.myfuture.bank" })
